        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "menu_name",
                    models.CharField(
                        help_text="Название категории для вывода", max_length=255, verbose_name="Название категории"
                    ),
                ),
                (
                    "image",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        help_text="Определяет положение картинки на странице", verbose_name="Номер картинки"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_published",
                    models.BooleanField(
                        choices=[(1, "Опубликовано"), (0, "Черновик")], default=1, verbose_name="Публикация"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True, verbose_name="Дата создания")),
                ("updated_at", models.DateTimeField(auto_now=True, null=True, verbose_name="Дата изменения")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "film_carousel",
                    models.CharField(
                        help_text="Название фильма для вывода", max_length=255, verbose_name="Название фильма"
                    ),
                ),
                (
                    "slogan",
                    models.CharField(
                        help_text="Информация для вывода 255 символов", max_length=255, verbose_name="Слоган фильма"
                    ),
                ),
                (
                    "slide_number",
                    models.PositiveIntegerField(
                        help_text="Порядок отоброжения слайдов следите что бы номера не повторялись",
